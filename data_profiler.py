...
def profile_values(values, description=""):
    prompt = f"""
        ...
        Provide:
        - Value type (e.g., name, email, datetime, age, etc)
...
if __name__ == "__main__":
    ...
    sample_values = ['johndoe@gmail.com', 'janesmith@gmail.com', 'bob.johnson@gmail.com', 'alice.williams@gmail.com', 'charlie.brown@gmail.com']
    ...
    # Call the function
    profile_report = profile_values(sample_values, description="") #This is a list of ages collected from a survey.")
